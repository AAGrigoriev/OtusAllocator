...
{
  std::list<double, Simple_Allocator<double, 216>> list;
...
{
  std::list<double, Simple_Allocator<double, 216>> list1;
  ASSERT_NO_THROW(list1.push_back(0));
  ASSERT_NO_THROW(list1.push_back(0));

  std::list<double, Simple_Allocator<double, 216>> list2(list1);
...
TEST(allocator, compare)
{
  ...
  list<double, Simple_Allocator<double, 24>> list1;
  list<double, Simple_Allocator<double, 24>> list2;
...
{
  Simple_Allocator<double, 64> allocator;
